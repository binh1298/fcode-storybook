...
export type GetCommentsListQuery = { __typename?: "query_root" } & {
    posts_by_pk?: Maybe<
        { __typename?: "posts" } & {
            comments: Array<
                ...
                > & { user?: Maybe<{ __typename?: "users" } & Pick<Users, "avatar" | "name">> }
            >;
        }
    >;
};
...
export type DeleteCommentMutation = { __typename?: "mutation_root" } & {
    delete_comments_by_pk?: Maybe<{ __typename?: "comments" } & Pick<Comments, "postId">>;
};
...
export type GetPostDetailQuery = { __typename?: "query_root" } & {
    posts: Array<
        { __typename?: "posts" } & Pick<Posts, "title" | "postId" | "content" | "createdAt"> & {
                user?: Maybe<{ __typename?: "users" } & Pick<Users, "avatar" | "name">>;
            }
    >;
};
...
export type UpdateCommentMutation = { __typename?: "mutation_root" } & {
    update_comments_by_pk?: Maybe<{ __typename?: "comments" } & Pick<Comments, "postId">>;
};
...
export type DeletePostMutation = { __typename?: "mutation_root" } & {
    delete_posts_by_pk?: Maybe<{ __typename?: "posts" } & Pick<Posts, "authorId">>;
};
...
export type InsertPostMutation = { __typename?: "mutation_root" } & {
    insert_posts_one?: Maybe<{ __typename?: "posts" } & Pick<Posts, "postId">>;
};

export type GetPostsListQueryVariables = Exact<{ [key: string]: never }>;

export type GetPostsListQuery = { __typename?: "query_root" } & {
    posts: Array<
        { __typename?: "posts" } & Pick<
            Posts,
            "authorId" | "content" | "createdAt" | "postId" | "title"
        >
    >;
    users: Array<{ __typename?: "users" } & Pick<Users, "avatar" | "name" | "userId">>;
};
...
export type UpdatePostByIdMutationMutation = { __typename?: "mutation_root" } & {
